...
def create_mock_response(status_code: int, json_data=None, headers=None, text=""):
    ...
    CRITICAL: httpx Response.json() is NOT async - it's a regular synchronous method.
    Therefore we use MagicMock (not AsyncMock) for the response object.
    ...
    # json() is a regular method (not async) that returns data directly
    if json_data is not None:
        response.json.return_value = json_data
    else:
        # If no json_data, make json() raise an error
...
class TestTokenIntrospection:
    ...
    @pytest.mark.asyncio
    async def test_introspect_token_active(self, keycloak_client, mock_http_client):
    ...
    async def test_introspect_token_inactive(self, keycloak_client, mock_http_client):
        ...
        mock_response = create_mock_response(200, json_data={"active": False})
        mock_http_client.post.return_value = mock_response
...
class TestOrganizationManagement:
    ...
    async def test_get_organization(
        ...
        mock_response = create_mock_response(200, json_data=sample_organization)
...
class TestClientManagement:
    ...
    async def test_create_client_success(
        ...
        # Mock POST response
        mock_post_response = create_mock_response(201)

        # Mock list clients response
        mock_list_response = create_mock_response(200, json_data=[sample_client])
    ...
    async def test_list_clients(
        ...
        mock_response = create_mock_response(200, json_data=[sample_client])
        mock_http_client.request.return_value = mock_response
    ...
    async def test_get_client_secret(
        ...
        mock_response = create_mock_response(200, json_data={"value": "super-secret"})
        mock_http_client.request.return_value = mock_response
...
class TestUserManagement:
    ...
    async def test_create_user_success(
        ...
        # Mock GET response
        mock_get_response = create_mock_response(200, json_data=sample_user)
    ...
    async def test_get_user(
        ...
        mock_response = create_mock_response(200, json_data=sample_user)
        mock_http_client.request.return_value = mock_response
...
class TestRoleManagement:
    ...
    async def test_assign_realm_role_to_user(
        ...
        mock_assign_response = create_mock_response(204)
...
class TestErrorHandling:
    ...
    async def test_create_organization_error_on_duplicate(
        ...
        mock_response = create_mock_response(409, text="Organization already exists")
        mock_http_client.request.return_value = mock_response
...
class TestTenantInfrastructure:
    ...
    async def test_create_tenant_infrastructure_success(
        ...
        mock_client_post = create_mock_response(201)
...
class TestPerformanceAndCaching:
    ...
    async def test_admin_token_reuse(
        ...
        mock_admin_response = create_mock_response(200, json_data=[])
